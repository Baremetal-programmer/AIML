% Naïve Bayes Classifier Example in MATLAB using Iris Dataset
...
nbModel = fitcnb(X_train, Y_train, 'DistributionNames', 'normal');

% Test the Naive Bayes model on test data
...
hold on;
title('Naive Bayes Classification - Test Data');
xlabel('Sepal Length');
ylabel('Sepal Width');
